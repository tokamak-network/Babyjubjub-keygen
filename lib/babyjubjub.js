...
class Jub {
  ...
  static decryptToVector(encrypted, privateKey){
  ...
  static encryptVector(vector, privateKey, random){
    assert(vector.constructor === Array);

    let k; // for private key
    let K; // for public key
...
function test(){
  ...
  let encrypted = Jub.encryptVector(vector1, "19611251047126512", "12312412524")
  console.log(encrypted);
  console.log("");
  console.log(Jub.decryptToVector(encrypted, "19611251047126512"));
}
